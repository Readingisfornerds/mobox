...
English
&nbsp;&nbsp;| &nbsp;&nbsp;
<a href="https://github.com/Readingisfornerds/mobox/blob/main/README-ru.md">Русский</a>
&nbsp;&nbsp;| &nbsp;&nbsp;
<a href="https://github.com/Readingisfornerds/mobox/blob/main/README-ua.md">Українська</a>
&nbsp;&nbsp;| &nbsp;&nbsp;
<a href="https://github.com/Readingisfornerds/mobox/blob/main/README-pt_BR.md">Português Brasileiro</a>
&nbsp;&nbsp;| &nbsp;&nbsp;
<a href="https://github.com/Readingisfornerds/mobox/blob/main/README-pl.md">Polski</a>
&nbsp;&nbsp;| &nbsp;&nbsp;
<a href="https://github.com/Readingisfornerds/mobox/blob/main/README-ja.md">日本語</a>
&nbsp;&nbsp;| &nbsp;&nbsp;
<a href="https://github.com/Readingisfornerds/mobox/blob/main/README-zh_CN.md">简体中文</a>
&nbsp;&nbsp;| &nbsp;&nbsp;
<a href="https://github.com/Readingisfornerds/mobox/blob/main/README-id.md">Bahasa Indonesia</a>
...
[Termux-X11](https://raw.githubusercontent.com/Readingisfornerds/mobox/main/components/termux-x11.apk) and
[Input Bridge](https://raw.githubusercontent.com/Readingisfornerds/mobox/main/components/inputbridge.apk).

2. Open termux and paste command

```bash
curl -s -o ~/x https://raw.githubusercontent.com/Readingisfornerds/mobox/main/install && . ~/x
```
